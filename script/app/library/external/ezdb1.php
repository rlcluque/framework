<?php
	...
	defined ("BAYOU_CORE") or die ("Acceso Restringido");
	...
	class db {
		...
		function connect()
		{
			...
			//global $codeSite;
			//if ($codeSite == "UTF-8") @mysql_query("SET NAMES 'utf8'");
		...
		function query($query)
		{
			...
			if ( preg_match("/^(insert|delete|update|replace)\s+/i",$query) )
			{
				...
				{	$dbh = $this->dbh;
					$this->insert_id = mysqli_insert_id($dbh); //rafa
					$return_val = mysqli_insert_id($dbh);
				}
				else
				{
