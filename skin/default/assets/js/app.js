var App = function () {
    ...
    var handleWysihtml5 = function () {
        ...
        // informacionWeb-descripcionCorta
         //$('#informacionWeb-descripcionCorta').wysihtml5();
         //$('#informacionWeb-descripcionLarga').wysihtml5();
        //$('.wysihtml5').wysihtml5();
        /*
        if ($('.wysihtml5').size() > 0) {
    ...
    return {
        ...
        blockLoadingUI: function (el, path,loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="'+path+'img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
                    backgroundColor: 'none'
